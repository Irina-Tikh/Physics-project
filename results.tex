...
\subsection{Comparison to Literature}
    ...
    Figures \ref{fig:dcm_x} and \ref{fig:dcm_l} show experimentan and literature spectra of dichloromethane, CH\(_2\)Cl\(_2\), which is one carbon atom with two covalent bonds to hydrogen atoms and two to chloride atoms. This 5-atomic molecule has 3*5-6, so 9 vibrational modes, all of which in theory are raman active. Table \ref{table:dcm} compares the recorded peaks to literature values, as well as notes the assigned 

    \begin{table}[h]
    \begin{center}
        \begin{tabular}{|c|c|c|}
         \hline
         Experimental Values (\( cm^{-1} \) ) & Literature Values  (\( cm^{-1} \) ) & Assingment  \\ 
         \hline
         175 & - & - \\
        ...
        \end{tabular}
        \label{table:dcm}
        \caption{Comparison of experimental and literature values, as well as assingment of raman bands of dichloromethane}
    \end{center}
    \end{table}
